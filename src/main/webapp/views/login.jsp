    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex">
		...
		<c:if test="${ !empty sessionScope.error1 }">
			<div class="alert alert-danger">${ sessionScope.error1 }</div>
			<c:remove var="error1" scope="session"></c:remove>
		</c:if>
		
		<!-- Body -->
		
		<div class="row mt-2 col-4 offset-4">
	<form method="POST"
			action="/Assignment_SOF3011_Quocdvph14459/login">
		<div class="mt-5">
		...
		<span class="text-danger">(*)Vui lòng đăng nhập để mua sắm.</span></div>
		<!-- Footer -->
		<div class="row mt-5">
